...
namespace BackupAes256.ViewModel
{
    ...
    public class DelegateCommand : ICommand
    {
        ...
        /// <summary>Initializes a new instance of the DelegateCommand class that can always execute.</summary>
        ...
        /// <summary>Initializes a new instance of the DelegateCommand class that executes conditionally.</summary>
        /// <param name="ExecuteMethod">Method that contains the command's execution logic.</param>
        /// <param name="CanExecuteMethod">Method that contains the command's execute condition logic.</param>
        /// <exception cref="ArgumentNullException">If the ExecuteMethod argument is null.</exception>
        public DelegateCommand(Action ExecuteMethod, Func<bool> CanExecuteMethod)
        {
            _ExecuteMethod = ExecuteMethod ?? throw new ArgumentNullException("DelegateCommand: ExecuteMethod must not be null");
            _CanExecuteMethod = CanExecuteMethod;
        }

        /// <summary>Part of the ICommand interface, determines whether the command
        /// can execute in the current program state.</summary>
        ...
        /// <summary>Part of the ICommand interface, defines the method
        /// to be called when the command is invoked.</summary>
        ...
        /// <summary>Part of the ICommand interface, invoked when changes
        /// occur that affect whether the command should execute.</summary>
